    ...
    <ScrollView style={styles.mainContainer}>
      <View>
          ...
          {tarjetas.map((tarjeta, i) => {
            if(tarjeta.estado === "Aprobado"){
              return <CheckBox
                ...
                onPress={() => setChecked(tarjeta.numero === checked ? null: tarjeta.numero)}
              />
            }
          })}
          <View style={styles.header}>
          ...
          <View style={styles.buttonArea}>
            {!visibilityModal1 && <Button style={styles.button} title='Nuevo' type='solid' onPress={openModal}/>}
            {!visibilityModal1 && !visibilityModalCreado && !visibilityModalEliminado && <Button style={styles.button} title='Borrar' type='solid' onPress={openModal2}/>}
          </View>
          <Modal
          ...
          <Modal
            ...
            >
              <View style={styles.confirmationModal}>
                ...
                <View style={styles.columns}>
                  <Button style={styles.modalButton} title='Sí' type='solid' onPress={handleBorrarMedio}/>
